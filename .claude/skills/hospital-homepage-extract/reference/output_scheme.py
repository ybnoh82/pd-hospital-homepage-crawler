...
class Address(BaseModel):
    ...
    sigungu: str | None = Field(None, description='시군구. 예: "강남구"')
    eupmyeondong: str | None = Field(None, description='읍면동. 예: "역삼동"')
...
class CrawlCost(BaseModel):
    ...
    model: str | None = Field(None, description='사용한 모델 ID. 예: "claude-fable-5"')
